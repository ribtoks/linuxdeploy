...
./linuxdeploy -exe ../tests/TestApp/TestApp -default-blacklist -strip -appdir $APP_DIR -overwrite -libs ../tests/TestLib/ -qmldir ../tests/TestApp/ -log linuxdeploy_blacklist.log
